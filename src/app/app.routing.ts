...
export const appRoutes: Route[] = [
    ...
    // Admin routes
    {
        ...
        children: [
            ...
            { path: 'research-settings', loadChildren: () => import('app/modules/admin/research-settings/research-settings.module').then((m) => m.ResearchSettingsModule) },
            { path: 'prompt-settings', loadChildren: () => import('app/modules/admin/prompt-settings/prompt-settings.module').then((m) => m.PromptSettingsModule) },
            { path: 'adverse-media', component: AdverseMediaPromptComponent },
