...
export class AuthService {
     ...
     * Setter & getter for access token
     */
    set userPermission(token: string) {
    ...
    signIn(credentials: { username: string; password: string }): Observable<any> {
        ...
        return this._httpClient.post(`${BASE_URI}/user/login`, credentials).pipe(
    ...
    signInUsingToken(): Observable<any> {
        ...
        return this._httpClient.get(`${BASE_URI}/user/api/auth/sign-in-with-token`, {
    ...
    signUp(user: {
        ...
        return this._httpClient.post(`${BASE_URI}/user/signup`, user);
    }
